...
There are several methods that have been used in the past to perform similar tasks, some of which include the use of algorithmic composition and Markov chains. 
...
have been defined, there is little to modify or fix. When using Markov chains for the generation of music, although the presented output has more variation, 
